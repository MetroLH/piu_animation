...
class _PiuAnimationWidgetState extends State<PiuAnimationWidget>
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) {
      ...
      _pathAnimation = Tween<double>(begin: 0.0, end: pathListLength).animate(
        CurvedAnimation(
    ...
    _animationController.addStatusListener((status) {
      ...
      if (status == AnimationStatus.completed) {
        ...
        if (widget.doSomethingFinishCallBack != null) {
          widget.doSomethingFinishCallBack!();
        }
      }
  ...
  Widget build(BuildContext context) {
    ...
    left = (MediaQuery.of(context).size.width - _scaleAnimation.value) / 2;
    top = (MediaQuery.of(context).size.height - _scaleAnimation.value) / 2;
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Positioned(
          left: _scaleAnimation.value > widget.minWidth ? left : dx,
          top: _scaleAnimation.value > widget.minWidth ? top : dy,
          ...
          child: Container(
            ...
            transform: Matrix4.identity()
              ...
              ..rotateY(_rotationZAngleAnimation.value * pi / 180),//翻转弧度
